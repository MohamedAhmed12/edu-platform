export default function () {
  ...
  com.wiris.js.JsBrowserData = $hxClasses[
    "com.wiris.js.JsBrowserData"
  ] = function () {};
  ...
  com.wiris.js.JsBrowser.prototype = {
    ...
    searchVersion: function (prop, search) {
      ...
      return (
        "" +
        Std.parseFloat(HxOverrides.substr(str, index + search.length + 1, null))
      );
    },
  ...
  com.wiris.js.JsPluginListener = $hxClasses[
    "com.wiris.js.JsPluginListener"
  ] = function () {};
  com.wiris.js.JsPluginListener.__name__ = [
    "com",
    "wiris",
    "js",
    "JsPluginListener",
  ...
  com.wiris.js.JsPluginTools = $hxClasses[
    "com.wiris.js.JsPluginTools"
  ] = function () {
    this.tryReady();
  };
  ...
  com.wiris.js.JsPluginViewer = $hxClasses[
    "com.wiris.js.JsPluginViewer"
  ] = function () {
    this._wrs_conf_imageFormat = null;
    this.javaServicePath = "/demo/plugins/app";
  ...
  com.wiris.js.JsPluginViewer.__name__ = [
    "com",
    "wiris",
    "js",
    "JsPluginViewer",
  ...
  com.wiris.js.JsPluginViewer.prototype = {
    ...
    isPerformanceEnabled: function () {
      ...
      if (haxe.Json.parse(data).status != "ok") return false;
      else
        return haxe.Json.parse(data).result.wirispluginperformance == "true"
          ? true
          : false;
    },
    ...
    callService: function (mml, servicename) {
      ...
      data +=
        "&metrics=true&centerbaseline=false&mml=" + StringTools.urlEncode(mml);
      data += "&lang=" + this.lang;
      if (this.zoom != 1) data += "&zoom=" + this.zoom;
      if (com.wiris.js.JsPluginViewer.DEBUG)
        haxe.Log.trace("Calling: " + url, {
          fileName: "JsPluginViewer.hx",
          lineNumber: 842,
          className: "com.wiris.js.JsPluginViewer",
          methodName: "callService",
        });
      if (com.wiris.js.JsPluginViewer.DEBUG)
        haxe.Log.trace("POST:" + data, {
          fileName: "JsPluginViewer.hx",
          lineNumber: 844,
          className: "com.wiris.js.JsPluginViewer",
          methodName: "callService",
    ...
    latexToMathml: function (latex, nodeAfter, asynchronously, callbackFunc) {
      ...
      var onloadFunc = function (e) {
        try {
          ...
          e.target.wiris.nodeAfter.parentElement.insertBefore(
            mathmlSpan,
            e.target.wiris.nodeAfter.nextSibling
          );
          newMathml.outerHTML = mathml;
          if (--_g.callsLatexToMathml == 0) {
            var _g2 = 0,
              _g1 = _g.eventListenersArray.length;
            while (_g2 < _g1) {
              var i = _g2++;
              try {
          ...
          if (com.wiris.js.JsPluginViewer.DEBUG)
            haxe.Log.trace("LatexToMathml call failed!", {
              fileName: "JsPluginViewer.hx",
              lineNumber: 804,
              className: "com.wiris.js.JsPluginViewer",
              methodName: "latexToMathml",
    ...
    callShowimage: function (
      ...
      while (_g1 < _g2) {
        ...
        else mmlEntities += character;
      }
      var md5 = haxe.Md5.encode(
      ...
      else data = "?formula=" + md5 + "&lang=" + this.lang;
      ...
      if (com.wiris.js.JsPluginViewer.DEBUG)
        haxe.Log.trace("Calling: " + url, {
          ...
          lineNumber: 654,
          className: "com.wiris.js.JsPluginViewer",
          methodName: "callShowimage",
        });
      if (com.wiris.js.JsPluginViewer.DEBUG)
        haxe.Log.trace("GET:" + data, {
          fileName: "JsPluginViewer.hx",
          lineNumber: 656,
          className: "com.wiris.js.JsPluginViewer",
          methodName: "callShowimage",
      ...
      var onloadFunc = function (e) {
        var getResultFunc = function (e1) {
          ...
          e1.target.wiris.img.src =
            result.format == "svg"
              ? "data:image/svg+xml;charset=utf8,"
              : "data:image/png;base64,";
          e1.target.wiris.img.src =
            e1.target.wiris.img.src + StringTools.urlEncode(result.content);
          ...
          if (result.height > 0) {
            if (com.wiris.js.JsPluginViewer.DEBUG)
              haxe.Log.trace(_g.calculateAlignment(height, baseline), {
                fileName: "JsPluginViewer.hx",
                lineNumber: 680,
                className: "com.wiris.js.JsPluginViewer",
                methodName: "callShowimage",
              });
            e1.target.wiris.img.style.verticalAlign =
              "-" + _g.calculateAlignment(scaledHeight, scaledBaseLine) + "px";
          ...
          if (_g.wiriseditormathmlattribute == null) {
            var wirisEditorMathmlAttributeCall = haxe.Json.parse(
              _g.callGetVariableKeys("wiriseditormathmlattribute")
            );
            if (wirisEditorMathmlAttributeCall.status != "ok")
              _g.wiriseditormathmlattribute = "data-mathml";
            else
              _g.wiriseditormathmlattribute =
                wirisEditorMathmlAttributeCall.result.wiriseditormathmlattribute;
          }
          ...
          if (result.alt != null) e1.target.wiris.img.alt = result.alt;
          else {
            var accessibilityResponse = _g.callService(
              e1.target.wiris.mml,
              "mathml2accessible"
            );
            if (haxe.Json.parse(accessibilityResponse).status != "error")
              e1.target.wiris.img.alt = haxe.Json.parse(
        ...
        if (haxe.Json.parse(con.responseText).status == "warning") {
          ...
          if (new com.wiris.js.JsBrowser().isIE())
            data =
              "centerbaseline=false&mml=" +
              StringTools.urlEncode(e.target.wiris.mml) +
              "&useragent=IE";
          else
            data =
              "centerbaseline=false&mml=" +
          ...
          con.onerror = function (e1) {
            if (com.wiris.js.JsPluginViewer.DEBUG)
              haxe.Log.trace("ShowImage call failed!", {
                fileName: "JsPluginViewer.hx",
                lineNumber: 744,
                className: "com.wiris.js.JsPluginViewer",
                methodName: "callShowimage",
    ...
    callCreateImage: function (mml, img) {
      ...
      if (height > 0) {
        if (com.wiris.js.JsPluginViewer.DEBUG)
          haxe.Log.trace(this.calculateAlignment(height, baseline), {
            fileName: "JsPluginViewer.hx",
            lineNumber: 606,
            className: "com.wiris.js.JsPluginViewer",
            methodName: "callCreateImage",
        ...
        img.style.verticalAlign =
          "-" + this.calculateAlignment(height, baseline) + "px";
    ...
    getTechnology: function () {
      if (
        HxOverrides.substr(com.wiris.js.JsPluginViewer.TECH, 1, null) ==
        "param.js.tech.discover@"
      ) {
        var con;
        con = new js.XMLHttpRequest();
    ...
    processMathML: function (mml, container, asynchronously, callbackFunc) {
      ...
      if (
        ...
        img.src =
          ...
          this.extension +
          "?mml=" +
          StringTools.urlEncode(mml);
      container.appendChild(img);
      if (com.wiris.js.JsPluginViewer.DEBUG)
        haxe.Log.trace(img.src, {
          fileName: "JsPluginViewer.hx",
          lineNumber: 542,
          className: "com.wiris.js.JsPluginViewer",
          methodName: "processMathML",
    ...
    getMathML_IE7: function (mathNode0) {
      ...
      while (mathNode != null && mathNode.nodeName != "/MATH") {
        if (mathNode.nodeType == 3) mathml += mathNode.nodeValue;
        else {
          ...
          if (nodeName.charAt(0) == "/")
            ...
            while (nextMathNode != null && counter > 0) {
              ...
              if (nextNodeName == nodeName) ++counter;
              else if (nextNodeName == "/" + nodeName) --counter;
    ...
    removeSemanticsMathml: function (mathml) {
      ...
      if (startSemantics != -1) {
        var startAnnotation = mathml.indexOf(
          openAnnotation,
          startSemantics + openSemantics.length
        );
        if (startAnnotation != -1)
          mathmlWithoutSemantics =
            mathml.substring(0, startSemantics) +
            mathml.substring(
              startSemantics + openSemantics.length,
              startAnnotation
            ) +
    ...
    replaceNodes: function (mathNodes, n, asynchronously, callbackFunc) {
      ...
      if (
        browser.getBrowser() == "Explorer" &&
        (browser.getVersion() == "6" || browser.getVersion() == "7") &&
        navigator.appVersion.indexOf("Trident") == -1
      ) {
        if (com.wiris.js.JsPluginViewer.DEBUG)
          haxe.Log.trace("Is ie7", {
            fileName: "JsPluginViewer.hx",
            lineNumber: 397,
            className: "com.wiris.js.JsPluginViewer",
    ...
    replaceLatexInTextNode: function (pos, node, asynchronously, callbackFunc) {
      ...
      if (pos < textContent.length) {
        ...
        if (nextLatexPosistion != null) {
          ...
          var latex = textContent.substring(
            nextLatexPosistion.start + "$$".length,
            nextLatexPosistion.end
          );
          this.latexToMathml(latex, leftTextNode, asynchronously, callbackFunc);
          this.replaceLatexInTextNode(
            nextLatexPosistion.end + "$$".length,
            node,
            asynchronously,
            callbackFunc
          );
    ...
    parseLatexElement: function (element, asynchronously, callbackFunc) {
      ...
      if (latexToProcess.length == 0) {
        var _g1 = 0,
          _g = this.eventListenersArray.length;
        while (_g1 < _g) {
          var i1 = _g1++;
          try {
    ...
    findTextNodes: function (el) {
      ...
      while ((node = walk.nextNode()))
        if (!this.thereIsParentTextArea(node)) textNodes.push(node);
      return textNodes;
    },
    ...
    doLoad: function () {
      ...
      this.asyncParam =
        this.params.exists("async") && this.params.get("async") == "true"
          ? true
          : false;
      ...
      else if (this.viewer == "latex") this.parseLatexDocument(this.asyncParam);
      else if (this.viewer == "all") {
        this.parseLatexDocument(this.asyncParam);
        this.parseDocument(this.asyncParam);
      }
      if (com.wiris.js.JsPluginViewer.DEBUG)
        haxe.Log.trace("Language:" + this.lang, {
          fileName: "JsPluginViewer.hx",
          lineNumber: 198,
          className: "com.wiris.js.JsPluginViewer",
          methodName: "doLoad",
  ...
  com.wiris.system.JsBrowserData = $hxClasses[
    "com.wiris.system.JsBrowserData"
  ] = function () {};
  com.wiris.system.JsBrowserData.__name__ = [
    "com",
    "wiris",
    "system",
    "JsBrowserData",
  ...
  com.wiris.system.JsOSData = $hxClasses[
    "com.wiris.system.JsOSData"
  ] = function () {};
  ...
  com.wiris.system.JsBrowser = $hxClasses[
  ...
  com.wiris.system.JsDOMUtils = $hxClasses[
    "com.wiris.system.JsDOMUtils"
  ] = function () {};
  com.wiris.system.JsDOMUtils.__name__ = [
    "com",
    "wiris",
    "system",
    "JsDOMUtils",
  ...
  com.wiris.system.JsDOMUtils.init = function () {
    ...
    com.wiris.system.JsDOMUtils.ieTouchEvents.set(
      "touchstart",
      "MSPointerDown"
    );
    ...
    com.wiris.system.JsDOMUtils.addEventListener(
      ...
      "MSPointerDown",
      function (e) {
        com.wiris.system.JsDOMUtils.internetExplorerPointers.set(
          "" + e.pointerId,
          e
        );
      }
  ...
  com.wiris.system.JsDOMUtils.addEventListener = function (
    element,
    eventName,
    handler
  ) {
    return com.wiris.system.JsDOMUtils.addEventListenerImpl(
      element,
      eventName,
      handler,
      false
  ...
  com.wiris.system.JsDOMUtils.addEventListenerImpl = function (
    ...
    if (
      ...
      com.wiris.system.JsDOMUtils.ieTouchEvents.exists(eventName)
    ) {
        ...
        function (e) {
          if (e.pointerType == "touch") {
            if (eventName == "MSPointerUp")
              com.wiris.system.JsDOMUtils.internetExplorerPointers.remove(
                "" + e.pointerId
              );
            else
              com.wiris.system.JsDOMUtils.internetExplorerPointers.set(
    ...
    if (
      eventName == "touchhold" &&
      com.wiris.system.JsDOMUtils.browser.isTouchable()
    ) {
      var timeout = null;
      var startX = -1;
      var startY = -1;
      var descriptor = com.wiris.system.JsDOMUtils.addEventListenerImpl(
        element,
        "touchstart",
        function (e) {
          touching = true;
      ...
      descriptor.subDescriptors.push(
        com.wiris.system.JsDOMUtils.addEventListenerImpl(
          element,
          "touchmove",
          function (e) {
            if (timeout != null) {
              if (
                Math.abs(e.touches[0].clientX - startX) >
                  com.wiris.system.JsDOMUtils.TOUCHHOLD_MOVE_MARGIN ||
          ...
          function (e) {
            if (touching) {
              ...
              if (
                ...
                currentTimestamp > firstClickTimestamp + 500
              )
  ...
  com.wiris.system.JsDOMUtils.removeEventListener = function (descriptor) {
    if (
      com.wiris.system.JsDOMUtils.browser.isIE() &&
      descriptor.element.detachEvent
    )
      descriptor.element.detachEvent(
        "on" + Std.string(descriptor.eventName),
        descriptor.handler
      );
    else
      descriptor.element.removeEventListener(
        descriptor.eventName,
        descriptor.handler,
        descriptor.useCapture
      );
  ...
  com.wiris.system.JsDOMUtils.isStyleRuleExists = function (selector) {
    ...
    var result =
      com.wiris.system.JsDOMUtils.getComputedStyleProperty(
        testComponent,
        "transition"
      ) != "all 0s ease 0s";
  ...
  com.wiris.system.JsDOMUtils.getComputedStyleProperty = function (
    element,
    name
  ) {
    var value;
    if (document.defaultView && document.defaultView.getComputedStyle) {
      ...
      value =
        computedStyle == null ? null : computedStyle.getPropertyValue(name);
    } else if (
      com.wiris.system.JsDOMUtils.browser.isIE() &&
      ...
      if (value != null && value.length > 0 && camelName != "zoom") {
        ...
        if (
          firstChar >= 48 &&
          firstChar <= 57 &&
          !StringTools.endsWith(value, "px")
        ) {
          var originalLeft = element.style.left;
          var originalRuntimeLeft = element.runtimeStyle
  ...
  com.wiris.system.JsDOMUtils.getElementsByClassName = function (
    parent,
    className,
    recursive
  ) {
    ...
    while (_g1 < _g) {
      ...
      if (recursive)
        returnValue = returnValue.concat(
          com.wiris.system.JsDOMUtils.getElementsByClassName(
            parent.childNodes[i],
            className,
            true
          )
  ...
  com.wiris.system.JsDOMUtils.getRelativeLeft = function (element, parent) {
    ...
    return (
      com.wiris.system.JsDOMUtils.getLeft(element) -
      com.wiris.system.JsDOMUtils.getLeft(parent)
    );
  };
  ...
  com.wiris.system.JsDOMUtils.getRelativeTop = function (element, parent) {
    ...
    return (
      com.wiris.system.JsDOMUtils.getTop(element) -
      com.wiris.system.JsDOMUtils.getTop(parent)
    );
  };
  ...
  com.wiris.system.JsDOMUtils.setWindowScroll = function (scroll) {
    js.Lib.window.scrollTo(
      js.Boot.__cast(scroll[0], Int),
      js.Boot.__cast(scroll[1], Int)
    );
  };
  ...
  com.wiris.system.JsDOMUtils.isDescendant = function (
    parent,
    possibleDescendant
  ) {
    if (possibleDescendant.parentNode == null) return false;
    if (possibleDescendant.parentNode == parent) return true;
    return com.wiris.system.JsDOMUtils.isDescendant(
      parent,
      possibleDescendant.parentNode
    );
  };
  ...
  com.wiris.system.JsDOMUtils.toggleClass = function (element, className) {
    ...
    else com.wiris.system.JsDOMUtils.addClass(element, className);
  };
  ...
  com.wiris.system.JsDOMUtils.setCaretPosition = function (
    element,
    position,
    end
  ) {
    ...
    if (range && range.parentElement() == element) {
      ...
      if (textInputRange.compareEndPoints("StartToEnd", endRange) > -1)
        ...
        if (textInputRange.compareEndPoints("EndToEnd", endRange) > -1)
          ...
          bounds[1] +=
            normalizedValue.slice(0, bounds[1]).split("\n").length - 1;
        }
      }
      return bounds;
    }
  ...
  com.wiris.system.JsDOMUtils.getMousePosition = function (target, e) {
    ...
    return com.wiris.system.JsDOMUtils.getMousePositionImpl(
      target,
      e,
      elementScroll,
      0
  ...
  com.wiris.system.JsDOMUtils.getMousePositionImpl = function (
    target,
    e,
    elementScroll,
    border
    ...
    position[0] =
      e.clientX -
      com.wiris.system.JsDOMUtils.getLeft(target) -
      border +
      elementScroll[0];
    position[1] =
      e.clientY -
      com.wiris.system.JsDOMUtils.getTop(target) -
      border +
      elementScroll[1];
    return position;
  };
  ...
  com.wiris.system.JsDOMUtils.getTouchPosition = function (target, touch) {
    ...
    elementScroll[0] = target.scrollLeft;
    elementScroll[1] = target.scrollTop;
    return com.wiris.system.JsDOMUtils.getTouchPositionImpl(
      target,
      touch,
      elementScroll,
      0
  ...
  com.wiris.system.JsDOMUtils.getTouchPositionImpl = function (
    target,
    touch,
    elementScroll,
    border
  ...
  com.wiris.system.JsDOMUtils.onTouchDeviceDetected = function (
    callbackFunction
  ) {
    com.wiris.system.JsDOMUtils.init();
    com.wiris.system.JsDOMUtils.touchDeviceListeners.push(callbackFunction);
  };
  com.wiris.system.JsDOMUtils.onMouseDeviceDetected = function (
    callbackFunction
  ) {
    com.wiris.system.JsDOMUtils.init();
  ...
  com.wiris.system.JsDOMUtils.rewriteDefaultPaths = function (contextPath) {
    if (
      window.com.wiris.js.defaultServicePath != null &&
      StringTools.startsWith(window.com.wiris.js.defaultServicePath, "http://")
    ) {
      var protocol = js.Lib.window.location.protocol;
      var defaultServicePathWithoutProtocol = window.com.wiris.js.defaultServicePath.substr(
        "http:".length
      );
      var reg = new EReg(
        "(http:|https:)" +
          defaultServicePathWithoutProtocol +
          "/" +
          contextPath,
        ""
      );
      ...
      if (protocol == "https:") {
        window.com.wiris.js.defaultServicePath =
          "https:" + defaultServicePathWithoutProtocol;
        if (window.com.wiris.js.defaultBasePath != null)
          window.com.wiris.js.defaultBasePath =
            "https:" +
            window.com.wiris.js.defaultBasePath.substr("http:".length);
      }
    }
  };
  com.wiris.system.JsDOMUtils.createCSSRules = function (selector, rules) {
    ...
    else if (style.sheet != null) style.sheet.addRule(selector, rules);
  };
  ...
  com.wiris.system.JsDOMUtils.exitFullscreen = function () {
    if (document.wrs_fullscreenElement != null)
      com.wiris.system.JsDOMUtils.removeClass(
        document.wrs_fullscreenElement,
        "wrsUI_aux_fullscreen"
      );
  ...
  com.wiris.system.JsDOMUtils.findServicePath = function (scriptName) {
    ...
    var _g1 = 0,
      _g = scriptTags.length;
    while (_g1 < _g) {
      var i = _g1++;
      var src = scriptTags[i].src;
      var j = src.lastIndexOf("/" + scriptName);
      if (j >= 0) servicePath = HxOverrides.substr(src, 0, j);
      else if (src == scriptName) servicePath = "";
    }
    if (
      servicePath != null &&
      StringTools.startsWith(servicePath, "http://") &&
      js.Lib.window.location.protocol == "https:"
    )
      servicePath =
        "https://" + HxOverrides.substr(servicePath, "http://".length, null);
    return servicePath;
  };
  ...
  com.wiris.system.JsDOMUtils.saveTextFile = function (
    elem,
    filename,
    filetype,
    contents
  ...
  com.wiris.system.JsDOMUtils.trapFocus = function (
    disabledFocusContainer,
    focusableContainer
  ) {
    var lastScroll = com.wiris.system.JsDOMUtils.getWindowScroll();
    var previousFocused = focusableContainer;
    var descriptor = com.wiris.system.JsDOMUtils.addEventListener(
      js.Lib.document,
      "focusin",
      function (e) {
    ...
    descriptor.subDescriptors.push(
      com.wiris.system.JsDOMUtils.addEventListener(
        ...
        function (e) {
          ...
          if (
            !com.wiris.system.JsDOMUtils.isDescendant(
              focusableContainer,
              focusedElement
            )
          ) {
            com.wiris.system.JsDOMUtils.setWindowScroll(lastScroll);
            var focusableElements = com.wiris.system.JsDOMUtils.getFocusableElements(
              js.Lib.document.body
            );
            ...
            var direction =
              previousFocused == focusedElement ||
              com.wiris.system.JsDOMUtils.elementIsBefore(
                previousFocused,
                focusedElement
              )
                ? 1
                : -1;
            var alternative = com.wiris.system.JsDOMUtils.findFocusableAlternative(
              focusableElements,
              disabledFocusContainer,
              focusableContainer,
              focusedElementIndex,
  ...
  com.wiris.system.JsDOMUtils.findFocusableAlternative = function (
    focusableElements,
    disabledFocusContainer,
    focusableContainer,
    focusedElementIndex,
    ...
    while (
      ...
      focusedElementIndex < focusableElements.length &&
      com.wiris.system.JsDOMUtils.isDescendant(
        disabledFocusContainer,
    ...
    if (focusedElementIndex < 0)
      return com.wiris.system.JsDOMUtils.findFocusableAlternative(
        focusableElements,
        disabledFocusContainer,
        focusableContainer,
        focusableElements.length - 1,
        -1,
        originalFocusedElementIndex
      );
  ...
  com.wiris.system.JsDOMUtils.elementIsBefore = function (elementA, elementB) {
    ...
    while (i < n) {
      if (pathA[i] != pathB[i])
        return (
          com.wiris.system.JsDOMUtils.getElementChildIndex(pathA[i]) <
          com.wiris.system.JsDOMUtils.getElementChildIndex(pathB[i])
        );
      ++i;
    }
    return false;
      ...
      while (true) {
        ...
        switch (c) {
          ...
          case 45:
            this.pos--;
            if (
              !this.reg_float.match(
                HxOverrides.substr(this.str, this.pos, null)
              )
            )
    ...
    serialize: function (v) {
      ...
      switch ($e[1]) {
        ...
        case 1:
          ...
          break;
        case 2:
          if (Math.isNaN(v)) this.buf.b += Std.string("k");
            ...
            case Array:
              ...
              while (_g < l) {
                ...
                if (v[i] == null) ucount++;
                  ...
                  if (ucount > 0) {
                    if (ucount == 1) this.buf.b += Std.string("n");
                    else {
  ...
  haxe.remoting.Connection = $hxClasses[
  ...
  haxe.remoting.HttpConnection.__name__ = [
    "haxe",
    "remoting",
    "HttpConnection",
  ];
